        ...
        <div className="list-container">
          <div className="food-category">
            ...
            <ul>
              ...
              <li className="food-item">
                <p className="food-title">
                  {t("vegetabletempuratitle")} <span> 7.00 </span>
                </p>
              ...
              <li className="food-item">
                <p className="food-title">
                  {t("tunasteaktitle")} <span> 16.00 </span>
                </p>
                <p className="food-description">{t("tunasteak")}</p>
              </li>
              <li className="food-item">
                <p className="food-title">
                  {t("dinnertunaspecialtitle")} <span> 16.00 </span>
                </p>
          ...
          <div className="food-category">
            ...
            <ul>
              ...
              <li className="food-item">
                <p className="food-title">
                  {t("seafoodmisotitle")} <span> 6.00 </span>
                </p>
          ...
          <div className="food-category">
            ...
            <ul>
              ...
              <li className="food-item">
                ...
                <ul>
                  <li>
                    {t("vegetarian")} <span> 15.00 </span>
                  </li>
                  <li>
                    {t("chicken")} <span> 17.00 </span>
                  </li>
                  <li>
                    {t("salmon")} <span> 19.00 </span>
                  </li>
                  <li>
                    {t("steak")} <span> 21.00 </span>
                  </li>
                  <li>
                    {t("seafood")} <span> 22.00 </span>
                  </li>
                </ul>
              </li>
              <li className="food-item">
                ...
                <ul>
                  ...
                  <li>
                    {t("shrimp")} <span> 21.00 </span>
                  </li>
                  <li>
                    {t("seafood")} <span> 24.00 </span>
                  </li>
                </ul>
              </li>
              <li className="food-item">
          ...
          <div className="food-category">
            ...
            <ul>
              ...
              <li className="food-item">
                <p className="food-title">
                  {t("sushisashimititle")} <span> 28.00 </span>
                </p>
